...
import { WebSearchContextPromptBuilder } from './builders/web-search-context-prompt.builder';
...
export class RoleplayPromptCompilerService {
  constructor(
    ...
    private readonly webSearchContextPrompt: WebSearchContextPromptBuilder,
  ...
  private createSystemPrompt(input: CompileInput): string {
    return [
      ...
      ...this.webSearchContextPrompt.build(input),
